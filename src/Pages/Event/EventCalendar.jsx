...
const EventCalendar = ({date, month, time,weekday}) => {
    return (
        ...
        <div className="event-date-month" style={{color:"#CCCCCC"}}><Regular14px19px text={month}/></div>
        </div>
        <hr className="calendar-divider"/>
        <div className='calendar-day'>
        <div className="event-date-month"><Bold16px22px text={time}/></div>
        <div className="event-date-day" style={{color:"#CCCCCC"}}><Regular14px19px text={weekday}/></div>
        </div>
      </div>
    );
}
